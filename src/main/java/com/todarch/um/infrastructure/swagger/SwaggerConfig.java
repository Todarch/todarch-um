package com.todarch.um.infrastructure.swagger;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
  ...
  private ApiInfo metaData() {
    return new ApiInfoBuilder()
        .title("Todarch User Management Service API")
        .description("\"Responsible for registration, authentication, user information etc.\"")
        .version("0.0.1")
